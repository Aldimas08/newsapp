...
class DetailPage extends StatefulWidget {
  ...
  DetailPage(
      {required this.article}); //{}kodingan yang didalam kurawal adalah object
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.vertical(top: Radius.circular(20)),//biar ujungnya melengkung
                      color: Colors.white),
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 20),//memberikan jarak kepada setiap sisi
                    child: Column(
